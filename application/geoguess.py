import os, math
from flask import Flask, redirect, session, url_for, escape, render_template, request, flash, session
...
def init():
    ...
    return render_template('base.html',app=app,user=CurrentUser, tables = scoretable, titles = catlist)
